...
The canonical development/training environment is Windows 10/11 x64 with Python 3.12. A discrete NVIDIA GPU is optional but recommended for faster training. CPU execution remains supported for correctness and smaller experiments.
